...
final class Version20200513063348 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sale_receipts (id INT AUTO_INCREMENT NOT NULL, cashbox_id INT NOT NULL, number VARCHAR(255) NOT NULL COMMENT \'(DC2Type:sale_receipts_number)\', date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', total DOUBLE PRECISION NOT NULL COMMENT \'(DC2Type:sale_receipts_total)\', INDEX IDX_39F0F082B5CA896 (cashbox_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE sale_receipts ADD CONSTRAINT FK_39F0F082B5CA896 FOREIGN KEY (cashbox_id) REFERENCES sale_cashbox (id)');
    }
